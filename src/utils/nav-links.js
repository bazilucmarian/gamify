...
export const navLinksUser = [
  ...
  {name: USER_CHALLENGES_ROUTE_NAME, link: USER_CHALLENGES_PAGE_ROUTE_LINK, exact: false},
  {name: USER_SHOP_ROUTE_NAME, link: USER_SHOP_PAGE_ROUTE_LINK, exact: false},
  {name: USER_SWITCH_ADMIN_ROUTE_NAME, link: USER_SWITCH_ADMIN_PAGE_ROUTE_LINK, exact: false}
];
...
export const navLinksAdmin = [
  ...
  {name: ADMIN_SHOP_ROUTE_NAME, link: ADMIN_SHOP_PAGE_ROUTE_LINK, exact: false},
